...
public static class InboundSapAccountToCreateCustomerODataModelFactoryMethods
{
    public static CreateCustomerODataModel ToCreateCustomerODataModel(
        this InboundSapToCrmCreateCustomerModelRequest createCustomerModelRequest)
    {
        ...
        return new CreateCustomerODataModel
        {
            ...
            address2_county = account.InvoiceCountry, //todo: add this field to inbound schema?
